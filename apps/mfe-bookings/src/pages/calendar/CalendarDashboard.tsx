        ...
        <div className="toolbar-left flex items-center gap-4">
          ...
          <div className="date-navigator">
            ...
            <Button
              ...
              ref={dateTriggerRef}
              className="date-picker-trigger flex items-center whitespace-nowrap border border-slate-200 bg-white font-bold text-slate-800"
              onClick={() => setIsDatePickerOpen(true)}
            >
              <span className="whitespace-nowrap">{formattedDate}</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="date-icon ml-2 text-purple-600">
