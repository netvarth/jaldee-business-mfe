...
export default function CreateAppointmentModal() {
  ...
  return (
    <div className="modal-card modal-lg" style={{ maxWidth: 900, width: "95%" }}>
      ...
      <form onSubmit={handleConfirm}>
        <div className="modal-body bg-light" style={{ padding: 24, maxHeight: "80vh", overflowY: "auto" }}>
          {/* Patient details */}
          <div style={{ marginBottom: 24, padding: 16, background: "#F8FAFC", borderRadius: 8, border: "1px solid var(--border-color)" }}>
            ...
            <div className="form-group mb-2">
              ...
              <input type="text" id="bk-patient-name" placeholder="Patient full name" required value={patientName} onChange={(e) => setPatientName(e.target.value)} />
            </div>
            <div className="form-row">
              <div className="form-group">
                <label htmlFor="bk-phone">Phone Number <span className="required">*</span></label>
                <input type="text" id="bk-phone" placeholder="+91 98765 43210" required value={phone} onChange={(e) => setPhone(e.target.value)} />
              </div>
              <div className="form-group">
                <label htmlFor="bk-email">Email Address</label>
                <input type="email" id="bk-email" placeholder="patient@email.com" value={email} onChange={(e) => setEmail(e.target.value)} />
              </div>
            </div>
          </div>
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <select id="bk-calendar" className="custom-select" required value={calendarUid} onChange={(e) => setCalendarUid(e.target.value)}>
            ...
            <div className="form-group">
              ...
              <select id="bk-service" className="custom-select" required value={serviceUid} onChange={(e) => setServiceUid(e.target.value)}>
          ...
          <div className="form-row mb-4">
            <div className="form-group">
              ...
              <select id="bk-doctor" className="custom-select" required value={doctorUid} onChange={(e) => setDoctorUid(e.target.value)}>
            ...
            <div className="form-group">
              ...
              <select id="bk-channel" className="custom-select" value={channel} onChange={(e) => setChannel(e.target.value as BookingChannel)}>
          ...
          {selectedDate && (
            <div className="info-banner mb-4" style={{ background: "#F8FAFC", border: "1px solid var(--border-color)", padding: 12, borderRadius: 8, textAlign: "center", fontWeight: 500, color: "var(--dark-text)" }}>
          ...
          <div className="booking-grid" style={{ display: "grid", gridTemplateColumns: "300px 1fr", gap: 24 }}>
              ...
              <div className="calendar-picker mt-2" style={{ background: "white", border: "1px solid var(--border-color)", borderRadius: 8, padding: 16 }}>
                <div className="calendar-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                  ...
                  <div className="calendar-nav">
                    <button type="button" className="btn-icon" onClick={() => setMonth(new Date(month.getFullYear(), month.getMonth() - 1, 1))}>&lt;</button>
                    <button type="button" className="btn-icon" onClick={() => setMonth(new Date(month.getFullYear(), month.getMonth() + 1, 1))}>&gt;</button>
                  </div>
                </div>
            ...
            <div className="slots-section">
              <div className="form-group mb-4">
                ...
                <select id="bk-schedule" className="custom-select" required value={scheduleUid} onChange={(e) => setScheduleUid(e.target.value)}>
          ...
          <div className="form-group mt-4">
            ...
            <textarea id="bk-notes" rows={3} placeholder="Enter notes here..." value={notes} onChange={(e) => setNotes(e.target.value)} />
          </div>
        </div>

        <div className="modal-footer" style={{ justifyContent: "flex-end", gap: 16 }}>
          <button type="button" className="btn btn-secondary" style={{ width: 120 }} onClick={closeModal}>CANCEL</button>
          <button type="submit" className="btn btn-primary" style={{ width: 120, background: "#3B0764", borderColor: "#3B0764" }} disabled={submitting}>
            {submitting ? "…" : "CONFIRM"}
          </button>
        </div>
      </form>
