  ...
  return (
    <div data-testid="jaldee-leads-template-builder-page" data-state={isSaving ? "loading" : status ? "status" : "idle"} className="h-full overflow-y-auto bg-slate-50 p-4 sm:p-6 md:p-8 pb-24">
      <PageHeader
        ...
        back={{ label: "Templates", href: "/jaldee-leads/templates" }}
        onNavigate={navigate}
        actions={
          <div className="flex items-center gap-2">
            <Button id="jaldee-leads-template-builder-cancel-button" data-testid="jaldee-leads-template-builder-cancel-button" variant="outline" onClick={() => navigate("/jaldee-leads/templates")}>
              Cancel
            </Button>
