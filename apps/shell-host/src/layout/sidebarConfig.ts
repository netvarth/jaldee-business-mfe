...
export const SIDEBAR_CONFIG: Partial<Record<ProductKey, SidebarSection[]>> = {
  ...
  hr: [
    ...
    { id: "hr-organization", label: "Organization", icon: "\u{1F3E2}", path: "/hr/org" },
    {
      id: "hr-recruitment",
      label: "Recruitment",
      icon: sidebarIcon(UserSearch),
      path: "/hr/recruitment",
      children: [
        { id: "hr-recruitment-overview", label: "Overview", icon: "", path: "/hr/recruitment" },
        { id: "hr-recruitment-requisitions", label: "Requisitions", icon: "", path: "/hr/recruitment/requisitions" },
        { id: "hr-recruitment-candidates", label: "Candidates", icon: "", path: "/hr/recruitment/candidates" },
        { id: "hr-recruitment-applications", label: "Applications", icon: "", path: "/hr/recruitment/applications" },
        { id: "hr-recruitment-interviews", label: "Interviews", icon: "", path: "/hr/recruitment/interviews" },
        { id: "hr-recruitment-offers", label: "Offers", icon: "", path: "/hr/recruitment/offers" },
        { id: "hr-recruitment-careers", label: "Careers", icon: "", path: "/hr/recruitment/careers" },
      ],
    },
