...
export default function PayableCreatePage() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const normalizedVendorUid = vendorUid && vendorUid !== EMPTY_UUID ? vendorUid : undefined;
      await financeApi.payables.create({
        ...
        consumerUid: normalizedVendorUid,
        vendorUid: normalizedVendorUid,
        paymentFor: "VERIFY",
        purpose: "REVENUE",
        isPaymentsIn: false,
        financeDirect: true,
        ...
        <form className="grid gap-5" onSubmit={handleSubmit}>
          ...
          <div className="grid gap-3">
            ...
            <FileUpload
              ...
              id="finance-payable-create-file-upload"
              testId="finance-payable-create-file-upload"
            />
