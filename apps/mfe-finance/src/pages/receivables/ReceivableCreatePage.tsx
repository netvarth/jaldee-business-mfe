...
async function uploadRevenueAttachments(
  file: File,
  input: {
...
export default function ReceivableCreatePage() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const response = await financeApi.revenue.create<any>({
        ...
        isPaymentsIn: true,
        financeDirect: true,
        paymentsInCategoryUid: categoryId || undefined,
        paymentsInStatusUid: statusId || undefined,
  ...
  function handleAttachmentSelection(files: File[]) {
    ...
    files.forEach((file) => {
      void uploadRevenueAttachments(file, {
        api: mfeProps.api,
        ...
        <form className="grid gap-5" onSubmit={handleSubmit}>
          ...
          <div className="grid gap-3">
            ...
            <FileUpload
              ...
              id="finance-receivable-create-file-upload"
              testId="finance-receivable-create-file-upload"
            />
