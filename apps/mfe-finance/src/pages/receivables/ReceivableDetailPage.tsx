...
export default function ReceivableDetailPage() {
  ...
  if (loading) {
    return (
      <PageShell title="Receivable Details" subtitle="Loading revenue record..." back={{ label: "Back to Receivables", href: "/receivables" }}>
        <SectionCard className="border-slate-200 shadow-sm">
          <div className="py-12 text-center text-slate-500 flex flex-col items-center justify-center gap-3">
            ...
            <span>Loading receivable details...</span>
          </div>
        </SectionCard>
      </PageShell>
    );
  ...
  if (!detail) {
    return (
      <PageShell title="Receivable Details" subtitle="Record not found" back={{ label: "Back to Receivables", href: "/receivables" }}>
        <SectionCard className="border-slate-200 shadow-sm">
      ...
      actions={
        <div className="flex gap-2">
          <Button
            ...
            onClick={() => navigate(`/finance/receivables/edit/${id}`)}
          >
            Edit
          </Button>
        </div>
