...
export const BASE_SERVICE_ENDPOINTS = {
  ...
  consumerGroups: {
    list: "/base-service/v1/api/tenant/consumers/group",
    create: "/base-service/v1/api/tenant/consumers/group",
    update: "/base-service/v1/api/tenant/consumers/group",
    detail: (uid: string) => `/base-service/v1/api/tenant/consumers/group/${pathValue(uid)}`,
    disable: (uid: string) => `/base-service/v1/api/tenant/consumers/group/${pathValue(uid)}/disable`,
    enable: (uid: string) => `/base-service/v1/api/tenant/consumers/group/${pathValue(uid)}/enable`,
    memberCount: (uid: string) => `/base-service/v1/api/tenant/consumers/group/${pathValue(uid)}/member/count`,
    byName: (groupName: string) => `/base-service/v1/api/tenant/consumers/group/by-name/${pathValue(groupName)}`,
  },
  consumerLabels: {
  ...
  tenants: {
    search: "/base-service/v1/api/tenants",
    create: "/base-service/v1/api/tenants",
    detail: (uid: string) => `/base-service/v1/api/tenants/${pathValue(uid)}`,
    update: (uid: string) => `/base-service/v1/api/tenants/${pathValue(uid)}`,
    delete: (uid: string) => `/base-service/v1/api/tenants/${pathValue(uid)}`,
    activate: (uid: string) => `/base-service/v1/api/tenants/${pathValue(uid)}/activate`,
    deactivate: (uid: string) => `/base-service/v1/api/tenants/${pathValue(uid)}/deactivate`,
    count: "/base-service/v1/api/tenants/count",
  },
  tenantLabels: {
  ...
  crmLeadActivities: {
    byLead: (leadUid: string) => `/base-service/v1/api/crm/lead/activities/lead/${pathValue(leadUid)}`,
    timeline: "/base-service/v1/api/crm/lead/activities/timeline",
  },
  crmLeadChannels: {
    list: "/base-service/v1/api/crm/lead/channels",
    create: "/base-service/v1/api/crm/lead/channels",
    detail: (uid: string) => `/base-service/v1/api/crm/lead/channels/${pathValue(uid)}`,
    update: (uid: string) => `/base-service/v1/api/crm/lead/channels/${pathValue(uid)}`,
    link: (uid: string) => `/base-service/v1/api/crm/lead/channels/${pathValue(uid)}/link`,
    status: (uid: string, status: string | number) =>
      `/base-service/v1/api/crm/lead/channels/${pathValue(uid)}/status/${pathValue(status)}`,
    encoded: (encodedId: string) => `/base-service/v1/api/crm/lead/channels/encoded/${pathValue(encodedId)}`,
    search: "/base-service/v1/api/crm/lead/channels/search",
  },
  crmLeadConsumers: {
    create: "/base-service/v1/api/crm/lead/consumers",
    detail: (uid: string) => `/base-service/v1/api/crm/lead/consumers/${pathValue(uid)}`,
    update: (uid: string) => `/base-service/v1/api/crm/lead/consumers/${pathValue(uid)}`,
    status: (uid: string) => `/base-service/v1/api/crm/lead/consumers/${pathValue(uid)}/status`,
    search: "/base-service/v1/api/crm/lead/consumers/search",
  },
  ...
  crmLeadNotes: {
    pin: (noteUid: string) => `/base-service/v1/api/crm/lead/notes/${pathValue(noteUid)}/pin`,
    unpin: (noteUid: string) => `/base-service/v1/api/crm/lead/notes/${pathValue(noteUid)}/unpin`,
    byLead: (leadUid: string) => `/base-service/v1/api/crm/lead/notes/lead/${pathValue(leadUid)}`,
    createForLead: (leadUid: string) => `/base-service/v1/api/crm/lead/notes/lead/${pathValue(leadUid)}`,
    pagedByLead: (leadUid: string) => `/base-service/v1/api/crm/lead/notes/lead/${pathValue(leadUid)}/paged`,
  },
  crmLeadPipelines: {
    create: "/base-service/v1/api/crm/lead/pipelines",
    addStage: (pipelineUid: string) => `/base-service/v1/api/crm/lead/pipelines/${pathValue(pipelineUid)}/stages`,
    reorderStages: (pipelineUid: string) =>
      `/base-service/v1/api/crm/lead/pipelines/${pathValue(pipelineUid)}/stages/reorder`,
    detail: (uid: string) => `/base-service/v1/api/crm/lead/pipelines/${pathValue(uid)}`,
    update: (uid: string) => `/base-service/v1/api/crm/lead/pipelines/${pathValue(uid)}`,
    activate: (uid: string) => `/base-service/v1/api/crm/lead/pipelines/${pathValue(uid)}/activate`,
    clone: (uid: string) => `/base-service/v1/api/crm/lead/pipelines/${pathValue(uid)}/clone`,
    deactivate: (uid: string) => `/base-service/v1/api/crm/lead/pipelines/${pathValue(uid)}/deactivate`,
    setDefault: (uid: string) => `/base-service/v1/api/crm/lead/pipelines/${pathValue(uid)}/default`,
    active: "/base-service/v1/api/crm/lead/pipelines/active",
    search: "/base-service/v1/api/crm/lead/pipelines/search",
    stageDetail: (stageUid: string) => `/base-service/v1/api/crm/lead/pipelines/stages/${pathValue(stageUid)}`,
    updateStage: (stageUid: string) => `/base-service/v1/api/crm/lead/pipelines/stages/${pathValue(stageUid)}`,
    deactivateStage: (stageUid: string) =>
      `/base-service/v1/api/crm/lead/pipelines/stages/${pathValue(stageUid)}/deactivate`,
  },
  crmLeadProducts: {
    create: "/base-service/v1/api/crm/lead/products",
    detail: (uid: string) => `/base-service/v1/api/crm/lead/products/${pathValue(uid)}`,
    update: (uid: string) => `/base-service/v1/api/crm/lead/products/${pathValue(uid)}`,
    status: (uid: string, status: string | number) =>
      `/base-service/v1/api/crm/lead/products/${pathValue(uid)}/status/${pathValue(status)}`,
    search: "/base-service/v1/api/crm/lead/products/search",
  },
  crmProviderLeads: {
    create: "/base-service/v1/api/provider/crm/leads",
    detail: (uid: string) => `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}`,
    update: (uid: string) => `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}`,
    assign: (uid: string) => `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}/assign`,
    notes: (uid: string) => `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}/notes`,
    sendMessage: (uid: string) => `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}/send-message`,
    active: (uid: string) => `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}/status/active`,
    complete: (uid: string) => `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}/status/complete`,
    noResponse: (uid: string) => `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}/status/noresponse`,
    reject: (uid: string) => `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}/status/reject`,
    unassign: (uid: string) => `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}/unassign`,
    migrationTemplate: "/base-service/v1/api/provider/crm/leads/migration/template",
    search: "/base-service/v1/api/provider/crm/leads/search",
  },
  crmLeadStages: {
    create: "/base-service/v1/api/crm/lead/stages",
    detail: (uid: string) => `/base-service/v1/api/crm/lead/stages/${pathValue(uid)}`,
    update: (uid: string) => `/base-service/v1/api/crm/lead/stages/${pathValue(uid)}`,
    complete: (uid: string) => `/base-service/v1/api/crm/lead/stages/${pathValue(uid)}/complete`,
    status: (uid: string, status: string | number) =>
      `/base-service/v1/api/crm/lead/stages/${pathValue(uid)}/status/${pathValue(status)}`,
    byLead: (leadUid: string) => `/base-service/v1/api/crm/lead/stages/lead/${pathValue(leadUid)}`,
    search: "/base-service/v1/api/crm/lead/stages/search",
  },
  crmLeadStageProgress: {
    setPipeline: (uid: string, pipelineUid: string) =>
      `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}/pipeline/${pathValue(pipelineUid)}`,
    reopen: (uid: string) => `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}/reopen`,
    history: (uid: string) => `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}/stage/history`,
    progress: (uid: string) => `/base-service/v1/api/provider/crm/leads/${pathValue(uid)}/stage/progress`,
  },
  crmLeadTemplates: {
    list: "/base-service/v1/api/crm/lead/templates",
    create: "/base-service/v1/api/crm/lead/templates",
    detail: (uid: string) => `/base-service/v1/api/crm/lead/templates/${pathValue(uid)}`,
    update: (uid: string) => `/base-service/v1/api/crm/lead/templates/${pathValue(uid)}`,
    search: "/base-service/v1/api/crm/lead/templates/search",
  },
} as const;
